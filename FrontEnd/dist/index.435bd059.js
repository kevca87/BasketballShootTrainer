...
var _courtJs = require("./Court.js");
window.addEventListener('load', function(event1) {
    var image = document.querySelector('img');
    var body = document.querySelector('body');
    var imageMargin = Math.round(0.125 * body.clientWidth);
    var court = new _courtJs.Court({
        x: imageMargin,
        y: 0
    }, {
        x: imageMargin + image.width,
        y: image.height
    });
...
},{"./Court.js":"fJUBZ"}],"fJUBZ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Court", ()=>Court1
);
...
var Court1 = /*#__PURE__*/ function() {
    function Court(pxPointCornerLS, pxPointCornerRI) {
    ...
    _createClass(Court, [
        {
            key: "getScaleXY",
            value: function getScaleXY(pxPoint) {
...
},{}]},["hVNDP","dxxdW"], "dxxdW", "parcelRequirec771")
